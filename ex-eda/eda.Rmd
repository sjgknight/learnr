...
```{r, eval=FALSE}
rmarkdown::run("ex-eda/cu-sipps-ggplot-aes-main/worksheet-1.Rmd")

```

* Running this chunk opens the next steps for learning ggplot, as an interactive 
```{r, eval=FALSE}
rmarkdown::run("ex-eda/cu-sipps-ggplot-aes-main/worksheet-2.Rmd")
...
#You might want to compare grouops, e.g. here, we're comparing the mpg variable by gear group. 
...
```{r}
rmarkdown::run("ex-eda/exploratory-master/inst/tutorials/1 Frequency histograms/Frequency_histograms.Rmd")

rmarkdown::run("ex-eda/exploratory-master/inst/tutorials/2 Descriptive statistics/Descriptive statistics.Rmd")

rmarkdown::run("ex-eda/exploratory-master/inst/tutorials/3 Boxplots/Boxplots.Rmd")

rmarkdown::run("ex-eda/exploratory-master/inst/tutorials/4 Scatterplots/Scatterplots.Rmd")
