---
title: "Data basics"
author: Lightly edited from example in "`r citation('learnr')`"
date: "`r Sys.Date()`"
output: 
  learnr::tutorial:
    progressive: true
...
Normally, we are not working with data from a package directly. Instead, we want to import data either by reading a file, or sometimes by steaming from an API. 
