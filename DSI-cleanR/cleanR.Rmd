...
The `refinr` hepls do this in a semi-automated way, and helpful one of the examples is for unis! 
```{r}
...
unis %>% refinr::key_collision_merge(university, ignore_strings = ignores) %>% 
    refinr::n_gram_merge(ignore_strings = ignores)
